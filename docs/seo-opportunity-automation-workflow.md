...
The goal is to implement a repeatable version of the Claude Code + Google Keyword Planner strategy while minimizing token usage.

## Core Principle

Do not make Claude or Claude Code rediscover the whole website every time.

Use scripts and compressed